...
namespace TodoApi.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        //[HttpGet(Name ="ToDoItems"),Authorize(AuthenticationSchemes = "Bearer",Roles ="Admin")]
        ...
        [Authorize(Policy = "UserPolicy")] // Requires "User" role
        [HttpGet("{id}")]
        ...
        [Authorize(Policy = "AdminPolicy")] // Requires "Admin" role
        [HttpDelete("{id}")]
